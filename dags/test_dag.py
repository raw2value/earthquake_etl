...
# константы для слоя и источника
LAYER = "raw"
SOURCE = "earthquake"

# S3
ACCESS_KEY = 'UWxLdoj8BnquhtrcwBOL'
SECRET_KEY = 'irq8Knh9nXVEOVgFUtMOY0HL5pdO9Fhv0wrKinLe'
...
args = {
    "owner": OWNER,
    "start_date": pendulum.datetime(2025, 5, 1, tz="Europe/Warsaw"),
    "catchup": True,
    "retries": 3,
